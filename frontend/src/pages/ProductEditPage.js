        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId='countInStock'>
              <Form.Label>Cantiate In Stoc</Form.Label>
              <Form.Control
                type='number'
                placeholder='Introduceti cantitate din stoc'
                value={countInStock}
